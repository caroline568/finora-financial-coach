  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Try again — pole, this happens sometimes.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Finora — your personal money coach" },
      {
        name: "description",
        content:
          "Finora is a warm, plain-spoken AI money coach for everyday life — one priority a day, honest answers, real progress.",
      },
      ...
      { property: "og:title", content: "Finora — your personal money coach" },
      {
        ...
        content:
          "One priority a day. A coach in your corner. Built for the way money actually moves — M-Pesa, chamas, real life.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Finora — your personal money coach" },
      { name: "description", content: "Finora is your personal money coach — one clear priority a day, built for how money actually moves in your life." },
      { property: "og:description", content: "Finora is your personal money coach — one clear priority a day, built for how money actually moves in your life." },
      { name: "twitter:description", content: "Finora is your personal money coach — one clear priority a day, built for how money actually moves in your life." },
